...
function Places(country, location, means, landmark, month, time) {
  ...
  obj.describe=function () {
    $("#display").append("It is Located in "+ this.country+", " +this.location + "you can travel by " + this.means + ". The first feature you are likely to see is " + this.landmark + " which is awesome. The best time to travel is " + this.month + " in the " + this.time+ ".");
  };
  return obj;
}
